-- Simple fix for user teams - create teams directly
...
SELECT 'Creating teams for users:' as info;

-- Insert teams for each user manually
-- Replace the user IDs with actual IDs from the users table
...
-- Step 5: If that didn't work, let's try a different approach
-- Create teams for specific users by email
INSERT INTO public.user_teams (user_id, player_id, player_name, position, price, is_captain, is_vice_captain)
SELECT 
