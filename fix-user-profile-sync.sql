-- Fix user profile sync for rupertweiner@gmail.com
...
-- Also check the auth.users table to make sure IDs match
SELECT 'Auth users verification...' as step;
SELECT 
  au.id as auth_id,
  u.id as public_id,
  au.email,
...
SELECT 'User profile sync complete!' as status;
